 ...
 *
 * START-HISTORY:
 * 14 Sep 26 dm  adopted from SD Core for Windows unchanged but for this line
 *               (W.4 phase 1, the owner's conformity rule).  Checked here by
 *               gplbld/test-scram-vectors.py, which runs verify-scram.c.
