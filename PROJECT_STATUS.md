...
**State (19 Sep 2026, ~10:30).**  ***THE INSTALL IS `359d5ce` (the fifth
...
5. ***[S.31] SD'S PASSWORD RULE — BUILT 19 Sep, UNMEASURED; §OPEN§ until
   the seventh cycle.*** Owner's ruling here (and so both ports'): SD
...
***[W.10] SELF-SERVICE MODIFY.PASSWORD — RULED AND §BUILT§ 19 SEP 2026;
§OPEN§ UNTIL A CYCLE AND A PERSON AT THE KEYBOARD MEASURE IT.***  The owner:
