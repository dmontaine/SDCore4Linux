...
(user, group, dir, home; no register record), then as before.  Held mail:
the port's 01:40 "install-time SD password is back, required" (their
RELEASE_1.1 70) sits in `to-linux/` unacted, on the owner's word, until
the cycle is done.
...
***AMENDED 18 SEP 2026, LATER: THE INSTALL NOW ASKS ONE PASSWORD, NOT TWO.***
